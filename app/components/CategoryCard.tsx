  ...
  return (
    <Link href={href} className="group relative overflow-hidden aspect-3/4 block cursor-pointer">
      ...
      <div className="absolute bottom-10 left-10 text-white">
        ...
        <p className="text-xs tracking-[0.2em] uppercase opacity-90 border-b border-white/50 pb-1 inline-block">
          {label}
        </p>
        {productCount !== undefined && (
          <p className="text-[10px] tracking-widest opacity-50 mt-2">
            {productCount} pieces
          </p>
        )}
      </div>
