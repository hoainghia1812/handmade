    ...
    <section className="py-24 bg-[#EBE4D5] dark:bg-neutral-900" id="story">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          {/* Text — slide from right, elements stagger */}
          <div className="space-y-8">
            <span className={`reveal from-right ${inView ? "in-view" : ""} block text-primary tracking-[0.4em] uppercase text-xs font-bold`}>
              The Maker&apos;s Mark
            </span>
            <h2 className={`reveal from-right reveal-delay-100 ${inView ? "in-view" : ""} font-display text-5xl md:text-6xl leading-tight italic`}>
              Rooted in Heritage, Crafted for Comfort.
            </h2>
            <p className={`reveal from-right reveal-delay-200 ${inView ? "in-view" : ""} text-lg leading-relaxed opacity-80`}>
            ...
            <p className={`reveal from-right reveal-delay-300 ${inView ? "in-view" : ""} text-lg leading-relaxed opacity-80`}>
            ...
            <div className={`reveal from-right reveal-delay-400 ${inView ? "in-view" : ""} pt-6`}>
